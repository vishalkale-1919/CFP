  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-eco-50 p-6">
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full border border-eco-100">
        <h2 className="text-3xl font-extrabold text-eco-900 text-center mb-2">Join EcoTrack</h2>
        <p className="text-center text-slate-500 mb-6">Start your journey to zero-net emissions today</p>
        ...
        <p className="text-sm text-center text-slate-600 mt-6">
          Already registered? <Link to="/login" className="text-eco-600 font-semibold hover:underline">Log in</Link>
        </p>
      </div>
    </div>
  );
